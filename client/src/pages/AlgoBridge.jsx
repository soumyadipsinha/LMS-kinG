    ...
    <section className="max-w-7xl mx-auto px-6 md:px-10 py-8">
      ...
      <div className="mb-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
            Choose the perfect plan to accelerate your career and master algorithms
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Basic Plan */}
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-3xl p-8 border-2 border-blue-200 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 group">
            <div className="text-center mb-6">
              <div className="w-20 h-20 mx-auto mb-4 bg-blue-500 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                <span className="text-4xl">🚀</span>
              </div>
              <h3 className="text-2xl font-black text-gray-900 mb-2">Basic Plan</h3>
              <div className="text-4xl font-black text-blue-600 mb-2">₹2,999</div>
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex items-center text-gray-700">
                ...
                Access to 50+ Practice Tests
              </li>
              <li className="flex items-center text-gray-700">
                <svg className="w-5 h-5 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                </svg>
                Basic Contest Participation
              </li>
              <li className="flex items-center text-gray-700">
                <svg className="w-5 h-5 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
            ...
            <button className="w-full py-4 px-6 bg-blue-600 text-white rounded-xl font-bold text-lg hover:bg-blue-700 hover:scale-105 transition-all duration-300 shadow-lg">
              Get Started
            </button>
          </div>

          {/* Pro Plan */}
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-3xl p-8 border-2 border-purple-300 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105 group transform scale-105">
            ...
            <div className="text-center mb-6">
              <div className="w-20 h-20 mx-auto mb-4 bg-purple-500 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                <span className="text-4xl">⭐</span>
              </div>
              <h3 className="text-2xl font-black text-gray-900 mb-2">Pro Plan</h3>
              <div className="text-4xl font-black text-purple-600 mb-2">₹5,999</div>
              <div className="text-gray-600">per month</div>
            </div>
            ...
            <button className="w-full py-4 px-6 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl font-bold text-lg hover:from-purple-700 hover:to-pink-700 hover:scale-105 transition-all duration-300 shadow-lg">
              Choose Pro
            </button>
          </div>

          {/* Enterprise Plan */}
          <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-3xl p-8 border-2 border-pink-200 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 group">
            <div className="text-center mb-6">
              <div className="w-20 h-20 mx-auto mb-4 bg-pink-500 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                <span className="text-4xl">🏆</span>
              </div>
              <h3 className="text-2xl font-black text-gray-900 mb-2">Enterprise</h3>
              <div className="text-4xl font-black text-pink-600 mb-2">₹12,999</div>
              <div className="text-gray-600">per month</div>
            </div>
            ...
            <button className="w-full py-4 px-6 bg-gradient-to-r from-pink-600 to-red-600 text-white rounded-xl font-bold text-lg hover:from-pink-700 hover:to-red-700 hover:scale-105 transition-all duration-300 shadow-lg">
              Contact Sales
            </button>
          </div>
        </div>
        ...
        <div className="mt-8 bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl p-6 text-white text-center">
          <h3 className="text-2xl font-black mb-2">💰 Save Big with Annual Plans!</h3>
          <p className="text-lg opacity-90">Get 2 months free when you choose annual billing</p>
        </div>
      </div>
